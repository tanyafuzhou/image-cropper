...
app.use("/fonts", express.static("demo/styles/fonts"));

app.get("/libs/react.min.js", function(req, res) {
  res.sendFile(path.join(__dirname, "libs/react-with-addons.js"));
});
app.get("/libs/react-dom.min.js", function(req, res) {
  res.sendFile(path.join(__dirname, "libs/react-dom.js"));
});
app.get("/libs/ReactRouter.min.js", function(req, res) {
